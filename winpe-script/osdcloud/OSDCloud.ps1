...
# powershell.exe -w h -c "$moduleInfo=Get-Module -ListAvailable -Name OSDCloud | Sort-Object Version -Descending | Select-Object -First 1; $workflowPath=Join-Path $moduleInfo.ModuleBase 'workflow'; $companyPath=Join-Path $workflowPath 'company'; $tasksPath=Join-Path $companyPath 'tasks'; New-Item -Path $companyPath -ItemType Directory -Force | Out-Null; New-Item -Path $tasksPath -ItemType Directory -Force | Out-Null; Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/3195abfe3eeab52ad23843a84e794f33/raw/spx-os-amd64.json' -OutFile (Join-Path $companyPath 'os-amd64.json'); Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/5c948fdae5bc4634352438660d9d61d2/raw/spx-os-arm64.json' -OutFile (Join-Path $companyPath 'os-arm64.json'); Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/4cfd046b499e2166c5bd8ead0882ddc8/raw/spx-user-amd64.json' -OutFile (Join-Path $companyPath 'user-amd64.json'); Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/5e24f80033daca58ff90ebc834fdeafb/raw/spx-user-arm64.json' -OutFile (Join-Path $companyPath 'user-arm64.json'); Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/c7d79a82a3a0bccec894a2102dc8ee8c/raw/spx-osdcloud.json' -OutFile (Join-Path $tasksPath 'osdcloud.json')"
# powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -Command "$moduleInfo = Get-Module -ListAvailable -Name OSDCloud | Sort-Object Version -Descending | Select-Object -First 1; $workflowPath = Join-Path $moduleInfo.ModuleBase 'workflow'; $companyPath = Join-Path $workflowPath 'company'; $tasksPath = Join-Path $companyPath 'tasks'; New-Item -Path $companyPath -ItemType Directory -Force | Out-Null; New-Item -Path $tasksPath -ItemType Directory -Force | Out-Null; Invoke-WebRequest -Uri '<GIST-RAW-URL-1>' -OutFile (Join-Path $companyPath 'os-amd64.json'); Invoke-WebRequest -Uri '<GIST-RAW-URL-2>' -OutFile (Join-Path $companyPath 'os-arm64.json'); Invoke-WebRequest -Uri '<GIST-RAW-URL-3>' -OutFile (Join-Path $companyPath 'user-amd64.json'); Invoke-WebRequest -Uri '<GIST-RAW-URL-4>' -OutFile (Join-Path $companyPath 'user-arm64.json'); Invoke-WebRequest -Uri '<GIST-RAW-URL-5>' -OutFile (Join-Path $tasksPath 'osdcloud.json')"

powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -Command ^
"$moduleInfo = Get-Module -ListAvailable -Name OSDCloud | Sort-Object Version -Descending | Select-Object -First 1; ^
$workflowPath = Join-Path $moduleInfo.ModuleBase 'workflow'; ^
...
Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/3195abfe3eeab52ad23843a84e794f33/raw/spx-os-amd64.json' -OutFile (Join-Path $companyPath 'os-amd64.json'); ^
Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/5c948fdae5bc4634352438660d9d61d2/raw/spx-os-arm64.json' -OutFile (Join-Path $companyPath 'os-arm64.json'); ^
Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/4cfd046b499e2166c5bd8ead0882ddc8/raw/spx-user-amd64.json' -OutFile (Join-Path $companyPath 'user-amd64.json'); ^
Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/5e24f80033daca58ff90ebc834fdeafb/raw/spx-user-arm64.json' -OutFile (Join-Path $companyPath 'user-arm64.json'); ^
Invoke-WebRequest -Uri 'https://gist.githubusercontent.com/checkitsedo/c7d79a82a3a0bccec894a2102dc8ee8c/raw/spx-osdcloud.json' -OutFile (Join-Path $tasksPath 'osdcloud.json')"
