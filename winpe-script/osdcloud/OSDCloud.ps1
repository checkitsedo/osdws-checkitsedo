...
powershell.exe -w h -c "Invoke-OSDCloudPEStartupCommand -Command ""Invoke-WebPSScript 'https://gist.githubusercontent.com/checkitsedo/8ef578c9165d78d73ec2005afe74cceb/raw/spx_osdcloud_Prepare-OSDCloudWorkflow.ps1'"" -Wait"
