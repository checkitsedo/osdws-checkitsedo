...
powershell.exe -w h -c Invoke-OSDCloudPEStartup Info; Invoke-WebPSScript https://gist.githubusercontent.com/checkitsedo/b9e272636a73a1c14aede5c47639ae97/raw/spx_osdcloud_bootstrap.ps1
